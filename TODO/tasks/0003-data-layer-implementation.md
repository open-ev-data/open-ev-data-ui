...
- [x] Create `env.ts`: Typed environment variables (API URLs, Feature flags)
- [x] Create `constants.ts`: Application constants (Pagination limits, default fallbacks)
- [x] Create `field-visibility.ts`: **Field Omission Logic**
