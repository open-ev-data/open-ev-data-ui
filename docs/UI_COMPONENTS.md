...
export function DataField<T>({ value, render }: {
...
│             │    │ brightness   │    │ scale(0.98)  │    │ opacity 0.4 │
│             │    │ +glow-cta    │    │             │    │ no pointer  │
└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```
...
```
┌─────────────────────────────────────────────────────────┐
│  🔍  Search EV Models, Specs, or Features...        🎤  │
└─────────────────────────────────────────────────────────┘
```
...
```
 Overview ╎ Charging Curve ╎ Range Scenarios ╎ Full Specs
 ━━━━━━━━╎              ╎                ╎
...
│         [Vehicle Image]             │
│                                     │
│  Vehicle Make + Model               │ ← --text-md, --weight-semibold
│                                     │
│  450     28.6    7.5               │ ← --text-base, --weight-bold
│  WLTP km  kWh   0-100km/h          │ ← --text-xs, --text-secondary
│                                     │
│  ┌─────────────────────────────┐   │
│  │        Compare              │   │ ← CTA button, --gradient-cta
│  └─────────────────────────────┘   │
└─────────────────────────────────────┘
```
...
```
┌────────────────────────────────────────────────────────────┐
│  [Image]  │  Vehicle Make + Model                     ♡   │
│           │  450        28.6 kWh      7.5                 │
│           │  WLTP km    Battery       0-100km/h           │
│           │  ┌──────────────────────────────────────────┐ │
│           │  │             Compare                      │ │
│           │  └──────────────────────────────────────────┘ │
└────────────────────────────────────────────────────────────┘
...
```
┌──────────┬──────────┬──────────┬──────────┐
│  $14.6k  │  450 km  │ 23.5 kWh │   3.8s   │
│  Price   │  WLTP    │ Battery  │ 0-100    │
└──────────┴──────────┴──────────┴──────────┘
```
...
```
┌──────────────────────────┐
│  Filtering               │ ← --text-lg, --weight-semibold
│                          │
│  Range (WLTP km)    500  │
│  ●━━━━━━━━━━━━━━━○───── │ ← Slider
│                          │
...
│  Market Availability     │
│  ☐ Market                │
│  ☑ Compared              │ ← Checkbox with --color-primary fill
│                          │
│  Vehicle Type            │
│  ☐ SUV                   │
│  ☐ Sedan                 │
...
│  └──────────┘  └──────────┘  └──────────┘                 │
│                                                             │
│  Range      │  150 km   │  7.7 km   │  2.3 km              │
│  Price      │  $14 km   │  $15 km   │  $22 km              │
│  0-100      │  5.4      │  4.4      │  4.5                 │
│                                                             │
│  ┌──Radar──┐  ┌──Radar──┐  ┌──Radar──┐                     │
│  │  Chart   │  │  Chart   │  │  Chart   │                     │
│  └─────────┘  └─────────┘  └─────────┘                     │
│                                                             │
│  [Efficiency Bars] [Efficiency Bars] [Efficiency Bars]     │
│  [Price vs Perf]   [Price vs Perf]   [Price vs Perf]       │
└──────────────────────────────────────────────────────────────┘
```
